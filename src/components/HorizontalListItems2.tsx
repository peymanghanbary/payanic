...
const itemW=width/1.2
const imageW=width/2.5-40
const imageH=imageW
export default function HorizontalListItems2({navigation,data={},title=""}:any) {
            ...
            <View style={{paddingTop:16}}>
                <View style={styles.item}>
                    ...
                    <View style={styles.imageContainer}>
                        <Image source={images.products.product2} style={styles.image}/>                        
                    </View>

                    <View style={{marginHorizontal:10,flex:1,justifyContent:'space-between',paddingVertical:20}}>
...
const styles=StyleSheet.create({
    item:{width:itemW,backgroundColor:'#fff',marginRight:10,borderRadius:10,flexDirection:'row-reverse'},
    ...
    likeButton:{backgroundColor:"white",elevation:1,width:40,height:40,borderRadius:10,position:'absolute',top:-15,left:5,zIndex:10,borderWidth:1,borderColor:"#eee",justifyContent:'center',alignItems:'center'},
